...
def test_logic_or(create_nacc_validator):
    ...
    assert nv.errors == {
        'raceaian': [
            'error in formula evaluation - value None does not satisfy the specified formula'
        ]
    }
...
def test_logic_and(create_nacc_validator):
    ...
    assert nv.errors == {
        'raceaian': [
            'error in formula evaluation - value 1 does not satisfy the specified formula'
        ]
    }
...
def test_logic_or_equality_with_none(create_nacc_validator):
    ...
    assert nv.errors == {
        'ftdsibby': [
            'error in formula evaluation - value 2000 does not satisfy the specified formula'
        ]
    }
    assert not nv.validate({
        'ftdsibby': 2000,
...
def test_logic_sum(create_nacc_validator):
    ...
    schema = {
        "var1": {
            "type": "integer"
        },  # important to note, additive logic does NOT support null values, so either
        "var2": {
            "type": "integer"
    ...
    assert nv.errors == {
        'total': [
            'error in formula evaluation - value 9 does not satisfy the specified formula'
        ]
    }
...
def test_logic_count_exact(create_nacc_validator):
    ...
    assert nv.errors == {
        'count': [
            'error in formula evaluation - value 5 does not satisfy the specified formula'
        ]
    }
    ...
    assert nv.errors == {
        'count': [
            'error in formula evaluation - value 4 does not satisfy the specified formula'
        ]
    }
...
def test_logic_count_exact_none(create_nacc_validator):
    ...
    assert nv.errors == {
        'count': [
            'error in formula evaluation - value 2 does not satisfy the specified formula'
        ]
    }
...
def test_logic_count_exact_invalid_list(create_nacc_validator):
    ...
    assert nv.errors == {
        'count': [
            'error in formula evaluation - count_exact needs a base and at least 1 value to compare to'
        ]
    }
